  ...
  def crypto(self, string):
    ...
    try:
      ...
      for crypto in valid_cryptos:
        #print ("DEBUG? %s%svalid_cryptos[crypto]: %s%svalid_cryptos[crypto]['coinmarketcap_id']: %s%svalid_cryptos[crypto]['name']: %s" % (self, '\n', valid_cryptos[crypto], '\n', valid_cryptos[crypto]['coinmarketcap_id'], '\n', valid_cryptos[crypto]['name'])) # TODO DEBUG
  ...
  def convert(self, string):
    ...
    try:
      ...
      for convert in valid_converts:
        #print ("DEBUG? %s%svalid_converts[convert]: %s%svalid_converts[convert]['coinmarketcap_id']: %s%svalid_converts[convert]['name']: %s" % (self, '\n', valid_converts[convert], '\n', valid_converts[convert]['coinmarketcap_id'], '\n', valid_converts[convert]['name'])) # TODO DEBUG
